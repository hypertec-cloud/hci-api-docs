...
curl -X GET \
   ...
   "https://hypertec.cloud/api/v2/services/compute-on/test_area/templates"
```
...
curl -X GET \
   -H "MC-Api-Key: your_api_key" \
"https://hypertec.cloud/api/v2/services/compute-on/test_area/templates/162cdfcb-45e5-4aa6-81c4-124c94621bdb"
```
> The above command returns a JSON structured like this:
...
curl -X POST \
   ...
   -H "MC-Api-Key: your_api_key" \
   -d "request_body" \
   "https://hypertec.cloud/api/v2/services/compute-on/test_area/templates/162cdfcb-45e5-4aa6-81c4-124c94621bdb?operation=update"
```
> Request body example:
