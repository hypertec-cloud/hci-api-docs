...
curl -X GET \
   ...
   "https://hypertec.cloud/api/v2/services/compute-on/test_area/isos"
```
...
curl -X GET \
   -H "MC-Api-Key: your_api_key" \
"https://hypertec.cloud/api/v2/services/compute-on/test_area/isos/162cdfcb-45e5-4aa6-81c4-124c94621bdb"
```
> The above command returns a JSON structured like this:
...
curl -X POST \
   ...
   -H "MC-Api-Key: your_api_key" \
   -d "request_body" \
   "https://hypertec.cloud/api/v2/services/compute-on/testing/isos/e922e5fc-8fee-4688-ad93-c9ef5d7eb685?operation=attach"
```
> Request body example:
...
curl -X POST \
   -H "Content-Type: application/json" \
   -H "MC-Api-Key: your_api_key" \
   "https://hypertec.cloud/api/v2/services/compute-on/testing/isos/e922e5fc-8fee-4688-ad93-c9ef5d7eb685?operation=generateDownloadUrl"
...
curl -X DELETE \
   -H "MC-Api-Key: your_api_key" \
   "https://hypertec.cloud/api/v2/services/compute-on/test_area/isos/84fc07a8-c6a3-4538-b493-11ce69ea3c88"
```
