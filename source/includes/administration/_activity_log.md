...
curl "https://hypertec.cloud/api/v2/organizations/activity" \
...
curl "https://hypertec.cloud/api/v2/activity_log" \
   -H "MC-Api-Key: your_api_key"
```
> The above command returns a JSON structured like this:
...
curl "https://hypertec.cloud/api/v2/activity_log/codes" \
   -H "MC-Api-Key: your_api_key"
```
> The above command returns a JSON structured like this:
...
curl "https://hypertec.cloud/api/v2/activity_log/summary" \
   -H "MC-Api-Key: your_api_key"
```
> The above command returns a JSON structured like this:
